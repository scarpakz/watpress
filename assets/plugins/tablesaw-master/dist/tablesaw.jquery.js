	...
	ColumnToggle.prototype.init = function() {
		...
		var cfg = this.tablesaw.getConfig({
			getColumnToggleLabelTemplate: function(text) {
				return "<a class='dropdown-item'><label class='custom-control custom-checkbox'><input type='checkbox' class='custom-control-input'>" +"<span class='custom-control-label'>" + text + "</span>" + "</label></a>";
			}
		});
